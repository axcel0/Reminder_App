...
class CircleView @JvmOverloads constructor(
    ...
    defStyleAttr: Int = 0 /* defStyleAttr */
) :
    ...
    /**
     * @return the current [Gravity] used to align/size the circle
     */
    var gravity: Int
        private set
    ...
    private fun invalidate(centerX: Float, centerY: Float, radius: Float) {
        invalidate(
            (centerX - radius - 0.5f).toInt(),
            (centerY - radius - 0.5f).toInt(),
            (centerX + radius + 0.5f).toInt(),
            (centerY + radius + 0.5f).toInt()
        )
    }
    ...
    companion object {
         ...
         */
        val FILL_COLOR: Property<CircleView, Int> = object : Property<CircleView, Int>(
            Int::class.java, "fillColor"
        ) {
         ...
         */
        val RADIUS: Property<CircleView, Float> = object : Property<CircleView, Float>(
